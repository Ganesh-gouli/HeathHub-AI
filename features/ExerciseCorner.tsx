            ...
            <div className="p-5 flex flex-col flex-grow">
                ...
                <div className="mt-auto pt-4 border-t border-gray-100 dark:border-gray-700">
                    ...
                    <button
                        ...
                        disabled={isLogged}
                    >
                        {isLogged ? 'Logged âœ”' : `Log Activity (~${(exercise.caloriesBurnedPerSet * setsCompleted).toFixed(0)} kcal)`}
                    </button>
                </div>
            </div>
        </div>
...
const ExerciseCorner: React.FC = () => {
    const [mode, setMode] = useState<'plan' | 'visualize' | 'form'>('plan');
        ...
        <div className="max-w-6xl mx-auto bg-white dark:bg-gray-800 p-4 md:p-8 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 animate-fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row border-b border-gray-200 dark:border-gray-700 mb-6">
                ...
                <button
                    ...
                    className={`flex items-center space-x-2 px-4 py-3 text-lg font-semibold border-b-2 transition-colors ${mode === 'form' ? 'border-green-500 text-green-600 dark:text-green-400' : 'border-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200'}`}
                >
